...
class WaitMedRecieve extends StatefulWidget {
  @override
  _WaitMedRecieveState createState() => _WaitMedRecieveState();
}

class _WaitMedRecieveState extends State<WaitMedRecieve> {
